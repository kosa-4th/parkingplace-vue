...
const getParkingLotDetails = async () => {
  try {
    ...
    const response = await axios.get(`${import.meta.env.VITE_API_URL}${import.meta.env.VITE_API_URL}/api/parkinglots/${parkinglotId}`);
...
const getHasFavorite = async () => {
  const response = await axios.get(`${import.meta.env.VITE_API_URL}${import.meta.env.VITE_API_URL}/api/favorites/parkingLot/${parkinglotId}/protected`);
...
const toggleFavorite = async () => {
  const response = await axios.post(`${import.meta.env.VITE_API_URL}${import.meta.env.VITE_API_URL}/api/favorites/protected`, null, {
    params: {
